        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Upload your model to analyze its fairness metrics across different demographic groups. 
              Our system will evaluate bias and discrimination patterns to help ensure equitable AI decisions.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <p className="text-gray-700 mb-4">
                    Fairness analysis ensures your AI system treats all groups equitably
                    and doesn't perpetuate harmful biases. By evaluating fairness metrics, you can:
                  </p>
                ...
                <div>
                  <p className="text-gray-700 mb-4">
                    Our comprehensive fairness assessment includes multiple metrics:
                  </p>
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-blue-500 rounded-full mr-3"></div>
                      <span className="text-gray-600">
                        <strong>Demographic Parity:</strong> Equal positive prediction rates
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
                      <span className="text-gray-600">
                        <strong>Equal Opportunity:</strong> Equal true positive rates
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
                      <span className="text-gray-600">
                        <strong>Disparate Impact:</strong> Ratio of selection rates
                      </span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-orange-500 rounded-full mr-3"></div>
                      <span className="text-gray-600">
                        <strong>Statistical Tests:</strong> Significance testing for bias
                      </span>
                    </div>
                  </div>
                </div>
