...
const SignupPage: React.FC = () => {
  ...
  // Add state for card slideshow on the right side
  ...
  return (
    <div className="min-h-screen flex flex-row bg-gradient-to-br from-white to-gray-50">
      ...
      <div className="lg:block lg:w-1/2 bg-white flex justify-center items-center p-8 pt-16">
        <div className="bg-purple-700 rounded-3xl shadow-2xl overflow-hidden w-full max-w-2xl border border-purple-500/30">
          <div className="p-8 md:p-12 h-full relative">
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-teal-400 opacity-20 rounded-full blur-xl -mr-10 -mt-10"></div>
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-pink-400 opacity-20 rounded-full blur-xl -ml-10 -mb-10"></div>
            ...
            <div className="inline-block px-5 py-1.5 bg-teal-500/20 border border-teal-400/30 rounded-full text-sm font-medium text-teal-300 mb-6 transform hover:scale-105 transition-transform duration-300 cursor-pointer shadow-lg">
              AI REGULATION RADAR
            </div>

            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Shaping the Future of{" "}
              <span className="text-teal-300">AI Governance</span>
            </h2>
